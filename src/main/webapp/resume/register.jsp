...
<title>Insert title here</title>
	...
	<body>
	<form  action="<%=request.getContextPath() %>/EngageResume/insertEngageResume" method="post" >
			...
			<table width="100%" border="1" cellpadding=0 cellspacing=0 
				...
				<tr>
					...
					<td width="13%" colspan="2" class="TD_STYLE2">
						<input type="date" name="humanBirthday" id="birthday" class="INPUT_STYLE2"  >
					</td>
				...
				<td class="TD_STYLE1">
					...
					<td class="TD_STYLE2">
						<input type="text" name="humanIdcard" id="card" class="INPUT_STYLE2">
					</td>
					<td class="TD_STYLE1">
						年龄
					</td>
