...
<body>
		...
		<form action="HumanFileController/updateHumanFileCheck" method="post">
			<table width="100%">
				<tr>
					<td>
				...
				<tr>
					<td align="right">
						<input type="submit" onclick="location.href='register_choose_attachment.jsp'" value="复核通过" class="BUTTON_STYLE1"/>
